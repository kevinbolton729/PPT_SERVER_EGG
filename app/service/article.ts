...
export default class ArticleService extends Service {
  ...
  public async ArticleQuantityModel() {
    const { ctx } = this;
  ...
  public async ArticleTodayQuantityModel() {
    const { ctx } = this;
  ...
  // [客户端]
  // 获取所有文章
  public async AllArticleFrontModel() {
    const { ctx } = this;
  ...
  // 根据栏目id，获取文章列表
  public async ArticleByIdFrontModel() {
    const { ctx } = this;
  ...
  // 根据文章id，获取文章详细内容
  public async ArticleDetailFrontModel(articleid = null) {
    const { ctx } = this;
